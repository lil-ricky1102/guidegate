...
if __name__ == "__main__":
    ...
    if args.split_settings == 'cluster':
        ...
        source_train_set.to_csv(dir_path+'/train/train.csv',index=False)
        target_train_set=pd.DataFrame(columns=column,data=target_train)
        target_train_set.to_csv(dir_path+'/valid/valid.csv',index=False)
        target_test_set=pd.DataFrame(columns=column,data=target_test)
        target_test_set.to_csv(dir_path+'/test/test.csv',index=False)
        ...
        val_set.to_csv(dir_path+'/valid/valid.csv',index=False)
